    ...
    return (
        <div>
            ...
            justify={'space-evenly'}>
                ...
                <Button rightIcon={<ArrowForwardIcon />} colorScheme='teal' variant='outline' margin={2}>
                    Login
                </Button>
            </Flex>
            <Center>
            ...
            <Flex justify={'center'}>
                ...
                justifyItems={'center'}>
                    ...
                    padding={4}> 
                        ...
                        <Link href='#' color={'red'} textDecoration={'underline'} textAlign={'center'}>Descubra nossos destinos!</Link>
                    </Text>
                </Flex>
            </Flex>
        </div>
